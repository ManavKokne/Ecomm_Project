...
//Retrieve user info and token from the localStorage if available
...
// Async Thunk for the user registration
...
const authSlice = createSlice({
    ...
    reducers : {
        logout : (state) => {
            ...
            localStorage.setItem("guestId", state.guestId); // Set the new guest Id in the localStorage
        },
