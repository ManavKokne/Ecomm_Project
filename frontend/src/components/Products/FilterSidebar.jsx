        ...
        <div className="flex flex-wrap gap-2">
          {colors.map((color) => (
            <button
              ...
              className={`w-8 h-8 rounded-full border border-gray-300 cursor-pointer transition hover:scale-105 ${filter.color === color ? "ring-2 ring-gray-500" : ""}`}
